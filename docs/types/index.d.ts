...
/**
* Interface describing `snanvariancewd`.
*/
interface Routine {
	/**
	...
	*/
	...
	/**
	* Computes the variance of a single-precision floating-point strided array ignoring `NaN` values and using Welford's algorithm and alternative indexing semantics.
	*
	* @param N - number of indexed elements
	* @param correction - degrees of freedom adjustment
	* @param x - input array
...
* // returns ~4.3333
*/
declare var snanvariancewd: Routine;


// EXPORTS //

export = snanvariancewd;
